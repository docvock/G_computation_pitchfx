...
OUT_FILES:= $(RDIR)/outfile/data_generate_3yr.Rout $(RDIR)/outfile/README.Rout $(RDIR)/outfile/data_manipulate_3yr.Rout $(RDIR)/outfile/pitchfx_models_3yr.Rout $(RDIR)/outfile/pitchfx_graphics_3yr.Rout $(RDIR)/outfile/counterfactual_outcomes_3yr.Rout
...
$(RDIR)/outfile/pitchfx_graphics_3yr.Rout: $(RDIR)/pitchfx_graphics_3yr.R $(RDIR)/pitchfx_models_3yr.R $(RDIR)/functions/pitchfx_models_3yr_function.R $(RDIR)/functions/pitchfx_models_graphics.R $(RDIR)/data_manipulate_3yr.R $(RDIR)/data_generate_3yr.R $(RDIR)/outfile/pitchfx_models_3yr.Rout
	R CMD BATCH --slave --vanilla pitchfx_graphics_3yr.R $(RDIR)/outfile/pitchfx_graphics_3yr.Rout
...
clean:
	rm -fv $(OUT_FILES) models_3yr.Rdata
