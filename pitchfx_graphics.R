...
pdf("baseball_graphics\\denisty_pitches_swing.pdf", height = 6, width = 12)
...
pdf("baseball_graphics\\denisty_sliders_swing.pdf", height = 6, width = 12)
spat.density(dataset = pitchfx_swing,
	crit.sc = which(is.na(pitchfx_swing$px) == F & pitchfx_swing$starlin == 1 & 
...
pdf("baseball_graphics\\denisty_pitches.pdf", height = 6, width = 12)
...
pdf("baseball_graphics\\denisty_sliders.pdf", height = 6, width = 12)
spat.density(dataset=pitchfx, 
...
# unadjusted analysis
pdf("baseball_graphics\\swing_prob_unadjusted.pdf", height = 6, width = 12)
swing_pred_plot(pt = "all", pt_name = "All Pitches")
dev.off()

pdf("baseball_graphics\\swing_prob_SL_unadjusted.pdf", height = 6, width = 12)
swing_pred_plot(pt = "SL", pt_name = "Sliders")
dev.off()

pdf("baseball_graphics\\swing_prob_FF_unadjusted.pdf", height = 6, width = 12)
swing_pred_plot(pt = "FF", pt_name = "Four-Seam Fastball")
dev.off()

pdf("baseball_graphics\\swing_prob_FT_unadjusted.pdf", height = 6, width = 12)
swing_pred_plot(pt = "FT", pt_name = "Two-Seam Fastball")
dev.off()


# model based analysis
pdf("baseball_graphics\\swing_prob_SL_count32_adjusted.pdf", height = 6, width = 12)
swing_adj_pred_plot(pt = "SL", pt_name = "Sliders", count = "3-2")
dev.off()

pdf("baseball_graphics\\swing_prob_FF_count32_adjusted.pdf", height = 6,width = 12)
swing_adj_pred_plot(pt = "FF", pt_name = "Four-Seam Fastball", count = "3-2")
dev.off()

pdf("baseball_graphics\\swing_prob_FT_count32_adjusted.pdf", height = 6, width = 12)
