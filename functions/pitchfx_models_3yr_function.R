...
gam_models <- function(pitchfx, batter_id, verbose = T, count_use = "1-1", sp.swing = rep(-1, 3), 
  ...
  # Returns:
	...
	if (verbose == T) {
		...
		pdf(paste("baseball_graphics_3yr/swing_gam_", batter_name_use, ".pdf", sep=""),
			width = 16, height = 10)
	...
	if(with(subset(pitchfx_swing_id, count=="3-0"), length(table(whiff)))<2){
	  ...
	  whiff_gam <- gam(whiff ~ s(start_speed, bs = "ts", k = 30) + as.factor(count) + 
		...
		pdf(paste("baseball_graphics_3yr/prob_whiff_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
		...
		pdf(paste("baseball_graphics_3yr/prob_whiff_given_swing_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
	...
	if (verbose == T) {
		...
		pdf(paste("baseball_graphics_3yr/prob_foul_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
		...
		pdf(paste("baseball_graphics_3yr/prob_foul_given_swing_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
	...
	if (verbose == T) {
		...
		pdf(paste("baseball_graphics_3yr/prob_hit_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
		...
		pdf(paste("baseball_graphics_3yr/prob_hit_given_swing_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
	...
	if (verbose == T) {
		...
		pdf(paste("baseball_graphics_3yr/expect_total_bases_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
		...
		pdf(paste("baseball_graphics_3yr/expect_total_bases_given_swing_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
	...
	if (verbose == T) {
		...
		pdf(paste("baseball_graphics_3yr/prob_called_strike_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
		...
		pdf(paste("baseball_graphics_3yr/prob_called_strike_given_noswing_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
		...
		pdf(paste("baseball_graphics_3yr/prob_ball_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
		...
		pdf(paste("baseball_graphics_3yr/prob_ball_given_noswing_", batter_name_use, ".pdf", sep=""), 
			width = 16, height = 10)
